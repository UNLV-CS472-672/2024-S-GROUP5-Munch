...
def follow_user(first_user, second_user):
    ...
    Args:
        ...
        second_user (str): The ID of the user to be followed.
    Returns:
    ...
    try:
        ...
        if (
            ...
            return (
                jsonify({"error": "Already following user"}),
        ...
        return (
            jsonify({"error": "Error unfollowing user"}),
...
def unfollow_user(first_user, second_user):
    ...
    Args:
        first_user (str): The ID of the user performing the action.
        second_user (str): The ID of the user to be unfollowed.
    Returns:
        dict: A message confirming the user has been unfollowed.
    Raises:
        ValueError: If an error occurs while connecting to the database.
        ValueError: If the any user is not found.
    """
    try:
        try_connect_to_db()
        ...
        if (
            ...
            return (
                jsonify({"error": "Not following user"}),
                status.HTTP_400_BAD_REQUEST,
            )
