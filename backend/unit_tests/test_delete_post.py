...
class TestAPI(unittest.TestCase):
    ...
    def test_delete_post(self):
        ...
        for user in user_docs:
            ...
            if user_data.get("bio", "") == "test_delete_post bio":
        ...
        new_post_data = {
            ...
            "description": "test_delete_post method",
            "likes": 0,
        ...
        for doc in docs:
            ...
            if doc_data.get("description", " ") == "test_delete_post method":
                global testing_id
                testing_id = doc.id
