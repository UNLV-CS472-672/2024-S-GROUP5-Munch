...
class TestAPI(unittest.TestCase):
    ...
    def test_update_post(self):
        ...
        for user in user_docs:
            ...
            if user_data.get('bio', "") == "test_update_post bio":
        ...
        # Put the new test id
        response = requests.put(f"{self.base_url}/{testing_id}", json=updated_post_data)
